...
final class LocalhostAdminBypass
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $authorRole = Role::query()->firstOrCreate(
            ...
            [
                'name' => 'Author',
                'description' => 'Author portal role.',
                'is_system' => true,
            ],
        );
        ...
        // Roles are attached only to the in-memory identity for this request.
        // They are never persisted for the localhost bypass account.
        $user->setRelation('roles', collect([$superAdminRole, $authorRole]));
    ...
    private function shouldBypass(Request $request): bool
    {
        ...
        if (! $request->is('admin', 'admin/*', 'author', 'author/*')) {
            return false;
        }
