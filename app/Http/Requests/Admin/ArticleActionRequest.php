...
final class ArticleActionRequest extends FormRequest
{
    ...
    {
        return [
            'action' => ['required', Rule::in(['publish', 'unpublish', 'schedule', 'feature', 'unfeature', 'trend', 'untrend', 'approve', 'reject', 'revision', 'minor_revision', 'major_revision', 'assign_editor', 'assign_reviewer'])],
