...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'manuscripts.initial-check', 'manuscripts.assign-reviewers', 'manuscripts.decide',
            'manuscripts.production', 'manuscripts.metadata-validate', 'manuscripts.doi.manage',
            'manuscripts.publish', 'manuscripts.override', 'internal-notes.manage',
        ];
        ...
        $roles['editor']->permissions()->sync($permissionModels->only([
            ...
            'comments.moderate', 'analytics.view', 'manuscripts.assign-reviewers', 'manuscripts.decide', 'internal-notes.manage',
        ])->pluck('id')->all());
        $roles['editorial-assistant']->permissions()->sync($permissionModels->only([
            'dashboard.view', 'articles.view', 'articles.view-unpublished', 'manuscripts.initial-check', 'internal-notes.manage',
        ])->pluck('id')->all());
        $roles['production-editor']->permissions()->sync($permissionModels->only([
            'dashboard.view', 'articles.view', 'articles.view-unpublished', 'manuscripts.production',
            'manuscripts.metadata-validate', 'manuscripts.doi.manage', 'manuscripts.publish', 'internal-notes.manage',
        ])->pluck('id')->all());
