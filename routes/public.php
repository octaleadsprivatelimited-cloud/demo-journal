...
Route::get('/about/stats', [PageController::class, 'aboutStats'])->name('about.stats');
...
Route::get('/retraction-policy', [PageController::class, 'retractionPolicy'])->name('retraction-policy');
