...
// LocalhostAdminBypass must execute before auth/active/verified. It is a
// request-scoped identity and still refuses every non-local request itself.
Route::middleware(['local-admin-bypass', 'auth', 'active', 'verified'])->group(function (): void {
