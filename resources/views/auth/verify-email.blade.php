...
@section('page-description', 'We sent a signed verification link to '.auth()->user()->email.'. Verification protects your identity and unlocks your approved workspace.')
@section('content')
