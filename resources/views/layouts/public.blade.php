...
@php
    ...
    $socialImage = trim($__env->yieldContent('image')) ?: asset('assets/sjc-logo-transparent.png');
    ...
    <header class="site-header" data-site-header>
        ...
        <div class="container masthead">
            ...
            <a class="brand" href="{{ route('home') }}" aria-label="{{ $siteName }} home">
                <img class="brand-logo" src="{{ asset('assets/sjc-logo-transparent.png') }}" alt="SJC International Journal" width="150" height="56">
            </a>
        ...
        <nav class="primary-nav" aria-label="Primary navigation">
            <div class="container nav-inner">
                <a class="nav-brand" href="{{ route('home') }}" aria-label="{{ $siteName }} home" hidden style="display:none" data-scroll-nav-brand>
                    <img src="{{ asset('assets/sjc-logo-transparent.png') }}" alt="SJC International Journal" width="106" height="40">
                </a>
    ...
    <footer class="site-footer">
        ...
        <div class="container footer-grid">
            ...
            <div>
                ...
                <a href="{{ route('retraction-policy') }}">Retraction policy</a>
                <a href="{{ route('appeal') }}">Appeal</a>
                <a href="{{ route('contact') }}">Contact</a>
